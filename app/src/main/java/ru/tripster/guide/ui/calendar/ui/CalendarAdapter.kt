...
import ru.tripster.guide.ui.calendar.CalendarView
...
import ru.tripster.guide.ui.calendar.utils.NO_INDEX
import ru.tripster.guide.ui.calendar.utils.getVerticalMargins
import ru.tripster.guide.ui.calendar.utils.inflate
import ru.tripster.guide.ui.calendar.utils.orZero
...
internal class CalendarAdapter(
    ...
    private var fromDateFilter: Boolean = false
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MonthViewHolder {
        ...
        val weekHolders = (1..6)
            .map { WeekHolder(createDayHolders(dayConfig), fromDateFilter) }
