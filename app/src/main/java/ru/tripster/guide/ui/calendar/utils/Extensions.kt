package ru.tripster.guide.ui.calendar.utils
...
fun daysOfWeekFromLocale(): Array<DayOfWeek> {
    /**
     * When your calendar's first day is Sunday just uncomment the code below
     * Otherwise, when your calendar is starting from Monday just use this function
     */
