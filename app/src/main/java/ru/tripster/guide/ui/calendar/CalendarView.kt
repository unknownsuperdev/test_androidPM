...
import ru.tripster.guide.ui.calendar.model.*
import ru.tripster.guide.ui.calendar.model.CalendarDay
import ru.tripster.guide.ui.calendar.model.CalendarMonth
import ru.tripster.guide.ui.calendar.ui.*
import ru.tripster.guide.ui.calendar.ui.CalendarAdapter
import ru.tripster.guide.ui.calendar.ui.CalendarLayoutManager
import ru.tripster.guide.ui.calendar.ui.ViewConfig
import ru.tripster.guide.ui.calendar.model.MonthConfig
import ru.tripster.guide.ui.calendar.ui.CalenderPageSnapHelper
import ru.tripster.guide.ui.calendar.utils.Size
import ru.tripster.guide.ui.calendar.utils.job
...
open class CalendarView : RecyclerView {
    ...
    private var months = listOf<CalendarMonth>()
    ...
    fun setupAsync(
        ...
        configJob = GlobalScope.launch {
            ...
            withContext(Main) {
                finishSetup(monthConfig, false)
                completion?.invoke()
            }
        }
    }

    fun addMonthsToCurrent() {
        calendarAdapter.monthConfig.months
    }

    private fun finishSetup(monthConfig: MonthConfig, fromDateFilter: Boolean) {
    ...
    fun updateMonthRange(
        ...
        this.startMonth = startMonth
        this.endMonth = endMonth
        val (config, diff) = getMonthUpdateData(Job(), removePastDays)
    ...
    private fun getMonthUpdateData(
        job: Job,
        removePastDays: Boolean? = null
    ): Pair<MonthConfig, DiffUtil.DiffResult> {
        val monthConfig = generateMonthConfig(job,removePastDays)
    ...
    private fun generateMonthConfig(job: Job,removePastDays:Boolean? = null): MonthConfig {
        return MonthConfig(
            outDateStyle,
            inDateStyle,
            maxRowCount,
            ...
            true,
            job,
            removePastDays = removePastDays,
            date = calendarAdapter.monthConfig.date
        )
    }
