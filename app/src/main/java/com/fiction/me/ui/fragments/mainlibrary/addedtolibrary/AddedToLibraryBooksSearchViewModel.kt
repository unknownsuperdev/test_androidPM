...
class AddedToLibraryBooksSearchViewModel(
    private val getSearchedBooksLibraryUseCase: FlowPagingUseCase<String, BooksWithReadProgressBookData>,
    ...
    val pagingData = _searchWord
        .map { getSearchedBooksLibraryUseCase(it ?: "") }
        .flatMapLatest { it }
