...
class LibrarySearchFragment :
    ...
    override fun onView() {
        ...
        with(binding) {
            ...
            toolBar.run {
                setTitleText(resources.getString(R.string.library))
    ...
    override fun onViewClick() {
        with(binding) {
            ...
            currentReadBooks.itemClickListener = { id, title ->
              ...
              /*  val directions =
                    LibrarySearchFragmentDirections.actionLibrarySearchFragmentToBookSummaryFragment(
                        id,
    ...
    private fun sendEvent(id: Long) {
        viewModel.run {
            ...
            trackEvents(
                BOOK_CLICKED,
                hashMapOf(PLACEMENT to SEARCH, REFERRER to LIBRARY, BOOK_ID_PROPERTY to id)
            )
        }
    }
